...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo constant('URL'); ?>public/css/default.css"/>  <!--La URL es una constante definida en un archivo externo-->
        ...
        <title>OXYGEN HYPERBARICS - Página de Errores</title>
    </head>
    ...
    <body>
        <div id="page-container"> <!-- Inserto el contenedor de página que llevará el GRID -->
            ...
            <!-- Compongo la página con sus partes componentes-->
            ...
            <div id='main-content'>
                <h1>ERROR: El recurso no existe. </h1>
            </div>
